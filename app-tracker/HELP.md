...
* The original package name 'com.cts.app.tracker.app-tracker' is invalid and this project uses 'com.cts.app.tracker.apptracker' instead.
...
* [GraalVM Native Image Support](https://docs.spring.io/spring-boot/docs/3.0.12/reference/html/native-image.html#native-image)
...
* [Configure AOT settings in Build Plugin](https://docs.spring.io/spring-boot/docs/3.0.12/maven-plugin/reference/htmlsingle/#aot)
...
```
$ docker run --rm -p 8080:8080 app-tracker:0.0.1-SNAPSHOT
```
